...
<body class="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 min-h-screen flex flex-col justify-center items-center text-white">
    ...
    <div class="text-center px-6">
        ...
        <div class="flex justify-center gap-4">
            <a href="{{ route('login') }}" class="bg-white text-indigo-600 font-semibold px-6 py-3 rounded-xl shadow-lg hover:bg-gray-100 transition duration-200">
                Login
            </a>
            <a href="{{ route('register') }}" class="border border-white font-semibold px-6 py-3 rounded-xl hover:bg-white hover:text-indigo-600 transition duration-200">
                Register
            </a>
        </div>
    </div>
    ...
    <footer class="absolute bottom-4 text-sm opacity-70">
        &copy; {{ date('Y') }} Laravel RBAC CRUD by <span class="font-semibold">Khaerul Azmi</span>
    </footer>
